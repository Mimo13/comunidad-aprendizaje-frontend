...
export const APP_MODULES: AppModule[] = [
  { key: 'DASHBOARD', label: 'Dashboard', description: 'Acceso general al panel de inicio' },
  ...
  { key: 'SETTINGS', label: 'Ajustes', description: 'Acceso al área de administración y configuración' },
  { key: 'ROLES', label: 'Perfiles', description: 'Gestión de roles y permisos de acceso' },
  { key: 'REPORTS', label: 'Informes', description: 'Generación y consulta de informes' },
