...
}, P = (s) => [d.prefix, s, d.suffix].filter((e) => e && e.length > 0).join("-"), Z = (s) => {
...
class k {
  ...
  handleAll(e) {
    ...
    const t = e.event, n = typeof e.request == "string" ? new Request(e.request) : e.request, a = "params" in e ? e.params : void 0, i = new ue(this, { event: t, request: n, params: a }), r = this._getResponse(i, n, t), c = this._awaitComplete(r, i, n, t);
    return [r, c];
  }
...
class de {
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: i } = te(n), r = typeof n != "string" && n.revision ? "reload" : "default";
...
const Q = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap();
function Le(s) {
...
function De(s) {
  return s === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return s.apply(N(this), e), f(Q.get(this));
  } : function(...e) {
    return f(s.apply(N(this), e));
  };
}
function Ne(s) {
  return typeof s == "function" ? De(s) : (s instanceof IDBTransaction && Pe(s), Ee(s, Ue()) ? new Proxy(s, M) : s);
}
function f(s) {
...
const N = (s) => K.get(s);
function Ie(s, e, { blocked: t, upgrade: n, blocking: a, terminated: i } = {}) {
...
const Me = ["get", "getKey", "getAll", "getAllKeys", "count"], Ae = ["put", "add", "delete", "clear"], I = /* @__PURE__ */ new Map();
function F(s, e) {
...
const Ke = "workbox-expiration", R = "cache-entries", q = (s) => {
...
self.skipWaiting();
Be();
be([{"revision":null,"url":"assets/ActivitiesPage-D7zqn-O_.js"},{"revision":null,"url":"assets/ActivityChartWidget-pbGm9na8.js"},{"revision":null,"url":"assets/ActivityDetailsModal-eZ8BNE1b.js"},{"revision":null,"url":"assets/AdminClassroomsPage-DXfXAmg7.js"},{"revision":null,"url":"assets/AdminHolidaysPage-DtPRxYfH.js"},{"revision":null,"url":"assets/AdminRolesPage-g5POju0D.js"},{"revision":null,"url":"assets/AdminStatsPage-Bp_3UuYb.js"},{"revision":null,"url":"assets/AdminSubjectsPage-C937XfAs.js"},{"revision":null,"url":"assets/AdminUsersPage-DXkGsBBT.js"},{"revision":null,"url":"assets/DashboardPage-B-tSo-cy.js"},{"revision":null,"url":"assets/EnrollmentDialog-CdzQqbKj.js"},{"revision":null,"url":"assets/ForgotPasswordPage-BYvJzTvI.js"},{"revision":null,"url":"assets/index-C7QrNK7N.js"},{"revision":null,"url":"assets/index-D8vAsJzF.css"},{"revision":null,"url":"assets/index-RTXU3a7E.js"},{"revision":null,"url":"assets/LoginPage-CsjAYo85.js"},{"revision":null,"url":"assets/mui-CghY9Qcp.js"},{"revision":null,"url":"assets/NotificationsPage-Nyht-AiW.js"},{"revision":null,"url":"assets/ProfilePage-Dtu8Hk24.js"},{"revision":null,"url":"assets/RegisterPage-t-mLGlRw.js"},{"revision":null,"url":"assets/ReportsPage-rMYwC3Qq.js"},{"revision":null,"url":"assets/ResetPasswordPage-B-qjIfuJ.js"},{"revision":null,"url":"assets/SettingsPage-FWROs-Pd.js"},{"revision":null,"url":"assets/SkeletonLoader-D5_7W9gm.js"},{"revision":null,"url":"assets/utils-Mwuwg66Q.js"},{"revision":null,"url":"assets/vendor-MVStETMZ.js"},{"revision":null,"url":"assets/workbox-window.prod.es5-B9K5rw8f.js"},{"revision":"d0362575bff865087d871d11c8978bcd","url":"index.html"},{"revision":"706a87904a3c173e9f552796c832f985","url":"pwa-192x192.png"},{"revision":"706a87904a3c173e9f552796c832f985","url":"pwa-512x512.png"},{"revision":"706a87904a3c173e9f552796c832f985","url":"pwa-maskable-192x192.png"},{"revision":"706a87904a3c173e9f552796c832f985","url":"pwa-maskable-512x512.png"},{"revision":"e2b6e167e31fe9b9c40e8320aa58d5fe","url":"manifest.webmanifest"}]);
g(
...
g(
  ({ url: s }) => s.pathname.includes("/api/activities"),
  new A({
...
g(
  ({ url: s }) => s.pathname.includes("/api/enrollments/my-enrollments"),
  new A({
...
g(
  ({ url: s }) => s.pathname.includes("/api/auth/me") || s.pathname.includes("/api/auth/profile"),
  new A({
    cacheName: "api-user",
    plugins: [
      new L({
...
self.addEventListener("push", (s) => {
  ...
  (!e || typeof e != "object") && (e = {});
  const { title: t, body: n, icon: a, badge: i, tag: r, url: c } = e, o = {
    body: n || "Tienes una nueva notificacion",
    icon: a || "/icon-192x192.png",
    badge: i || "/icon-72x72.png",
    tag: r || "push-generic",
    vibrate: [200, 100, 200],
    data: {
      dateOfArrival: Date.now(),
      primaryKey: r || "push-generic",
      url: c || "/notifications"
    },
    actions: [
      {
  ...
  s.waitUntil(
    self.registration.showNotification(t || "Nueva notificacion", o)
  );
});
self.addEventListener("notificationclick", (s) => {
  s.notification.close();
  const e = s.notification.data, t = (e == null ? void 0 : e.url) || "/";
  s.waitUntil(
    async function() {
      ...
      for (const a of n)
        if (a.url.includes(t) && "focus" in a)
          return a.focus();
...
self.addEventListener("sync", (s) => {
  s.tag === "sync-notifications" && s.waitUntil(Fe());
});
async function Fe() {
  try {
    const s = await caches.open("notifications-sync"), e = await s.keys();
    for (const t of e)
      try {
        (await fetch(t)).ok && await s.delete(t);
      } catch (n) {
        console.error("Error sincronizando notificación:", n);
      }
  } catch (s) {
    console.error("Error en sincronización de notificaciones:", s);
  }
}
